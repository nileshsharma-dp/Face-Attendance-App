            ...
            for encode_face, face_Loc in zip(encode_cur_frame, facesCurFrame):
                ...
                if matches[match_index]:
                    ...
                    if counter == 0:
                        ...
                        # Display text with a filled rectangle background using cvzone
                        # cvzone.putTextRect(imgbackgrnd, "Loading", (275, 400), 
                        #             scale=6, 
                        #             thickness=5, 
                        #             colorR=(0, 0, 0),  # Text color (Black)
                        #             colorT=(255, 255, 255),  # Rectangle color (White)
                        #             border=0)  # No border to make it look filled
                        cvzone.putTextRect(imgbackgrnd, "Loading", (275, 400))  
